...
export class AddTransactionTable1747909595106 implements MigrationInterface {
  name = 'AddTransactionTable1747909595106';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "transaction_detail" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isRedeemed" boolean NOT NULL DEFAULT false, "transactionId" uuid, "itemId" uuid, CONSTRAINT "PK_bafdd7fde2ed67494cf9cd9ec2a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
